  ...
  `;
    ...
    async function addFieldsEvent() {
      try {
        ...
        const selectCommentWalkSpeed = document.querySelector(
          `#${prefix}select-comment-walk-speed`,
        );

        if (selectCommentWalkSpeed) {
          selectCommentWalkSpeed.value =
            await commentWalkService.getCommentWalkSpeed();
          selectCommentWalkSpeed.addEventListener("change", async (e) => {
            const commentWalkSpeed = e.target.value;
            try {
              await commentWalkService.setCommentWalkSpeed(commentWalkSpeed);
            } catch (error) {
              handleErrorHelper({
                name: "selectCommentWalkSpeed",
                error,
              });
