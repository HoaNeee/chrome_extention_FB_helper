...
function drawDataCommentWalkElement({
  ...
  try {
    ...
    const divFieldDescriptionForAi = document.createElement("div");
    divFieldDescriptionForAi.classList.add(`${prefix}field-container`);
    const labelDescriptionForAi = document.createElement("label");
    labelDescriptionForAi.innerText = getTextWithLanguage({
      vi: "Mô tả cho AI (Không bắt buộc):",
      en: "Description for AI (Optional):",
    });

    const inputDescriptionForAi = document.createElement("textarea");
    inputDescriptionForAi.setAttribute(
      "id",
      `${prefix}input-description-for-ai`,
    );
    inputDescriptionForAi.classList.add(`${prefix}input-outline`);
    inputDescriptionForAi.placeholder = "Example: tim phong tro, tai chinh,...";
    inputDescriptionForAi.rows = 3;

    if (initialData) {
      inputDescriptionForAi.value = initialData.description_for_ai || "";
    }

    divFieldDescriptionForAi.appendChild(labelDescriptionForAi);
    divFieldDescriptionForAi.appendChild(inputDescriptionForAi);
    ...
    divInner.appendChild(divFieldDescriptionForAi);
    ...
    btnSave.addEventListener("click", async () => {
      try {
        ...
        const payload = {
          ...
          description_for_ai: inputDescriptionForAi.value,
        };
